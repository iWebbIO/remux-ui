...
<p align="center">
  <a href="https://github.com/iWebbIO/remux-ui/releases"><img src="https://img.shields.io/github/v/release/iWebbIO/remux-ui" alt="Release"></a>
  <a href="https://github.com/iWebbIO/remux-ui/actions"><img src="https://img.shields.io/github/actions/workflow/status/iWebbIO/remux-ui/release.yml.svg" alt="Build"></a>
  <a href="#"><img src="https://img.shields.io/github/go-mod/go-version/iWebbIO/remux-ui.svg" alt="GO Version"></a>
  <a href="https://github.com/iWebbIO/remux-ui/releases/latest"><img src="https://img.shields.io/github/downloads/iWebbIO/remux-ui/total.svg" alt="Downloads"></a>
...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/iWebbIO/remux-ui/master/install.sh)
```

Belirli bir sürümü kurmak için, etiketini (ör. `v3.4.0`) ekleyin:

```bash
bash <(curl -Ls https://raw.githubusercontent.com/iWebbIO/remux-ui/master/install.sh) v3.4.0
```
...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/iWebbIO/remux-ui/master/install.sh) dev-latest
```
...
Tam dokümantasyon için lütfen [proje Wiki sayfasını](https://github.com/iWebbIO/remux-ui/wiki) ziyaret edin.
...
```bash
docker run -d --cap-add=NET_ADMIN --cap-add=NET_RAW ... ghcr.io/iwebbio/remux-ui
```
...
[![Zaman içerisindeki yıldız sayısı](https://starchart.cc/iWebbIO/remux-ui.svg?variant=adaptive)](https://starchart.cc/iWebbIO/remux-ui)
